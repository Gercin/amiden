...
<form class="form-block__form form" id="form-main" data-type="js-form" data-url="<?= SITE_TEMPLATE_PATH . '/include/ajax/feed_form.php' ?>" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" data-type="get-field" data-uf="UF_FORM" value="event_form">
    <?php if ($detailID):?>
        <input type="hidden" data-type="get-field" data-uf="UF_EVENT" value="<?= $detailID?>">
    <?php else:?>
        <input type="hidden" data-type="get-field" data-uf="UF_EVENT" value="">
    <?php endif;?>
    <div class="form__wr">
        <div class="form__col">
        ...
        <div class="form__col">
            <div class="form__item">
                <input type="text" class="form-input with-label" data-type="get-field" data-uf="UF_WORK" data-reset="y">
                <label class="form-label">Место работы</label>
            </div>
        </div>
        <div class="form__col">
            <div class="form__item">
                <input type="text" class="form-input with-label" data-type="get-field" data-uf="UF_SPEC" data-reset="y">
...
<a data-fancybox href="#form_event_resp" style="display: none;"></a>
<div style="display: none; width: 50%;" id="form_event_resp" data-type="form_resp">
