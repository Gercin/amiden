...
<form class="form-block__form form" id="form-main" data-type="js-form" data-url="<?= SITE_TEMPLATE_PATH . '/include/ajax/feed_form.php' ?>" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" data-type="get-field" data-uf="UF_FORM" value="feed_form_modal">
    <div class="form__wr">
        <div class="form__col">
...
<a data-fancybox href="#form_modal_resp" style="display: none;"></a>
<div class="popup-form" style="display: none; width: 50%;" id="form_modal_resp" data-type="form_resp">
