...
<div class="popup-form" style="display: none; width: 50%;" id="modal_form_main">
	<div class="form-block">
		<div class="form-block__wr">
            ...
            <?php include_once $_SERVER['DOCUMENT_ROOT'] .'/local/templates/main/include/forms/form_modal.php';?>
		</div>
	</div>
	<script>
