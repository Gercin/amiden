...
<div class="call-modal" data-fancy-modal="call">
    <div class="call-modal__container">
        ...
        <form class="form" data-parsley-validate="data-parsley-validate" data-form="call-form" data-type="js-form" data-url="<?= SITE_TEMPLATE_PATH . '/include/ajax/feed_form.php' ?>">
        <input type="hidden" data-type="get-field" data-uf="UF_TITLE" value="Обратный звонок - <?= $APPLICATION->ShowTitle(false) ?>">
            ...
            <div class="form__item">
                <input class="form__input" id="input" type="tel" placeholder="Телефон*" required="required" data-tel-input="data-tel-input" data-type="get-field" data-uf="UF_PHONE" />
            </div>
            <div class="form__inner">
                <div class="checkbox">
                    ...
                    <a class="checkbox__link" href="<?= $privacyPolicyFile ?>" target="_blank">персональных данных</a>
                </div>
            </div>
            <div class="form__inner">
