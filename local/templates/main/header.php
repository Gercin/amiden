...
<head>
    ...
    <meta property="vk:image"
        content="https://<?= $_SERVER['HTTP_HOST'] . SITE_TEMPLATE_PATH ?>/images/main-banner-meta.webp">
...
<body class="<?= $APPLICATION->ShowProperty('classBody'); ?> new-main">
    ...
    <main class="main "> <!---   main    --->
        <div class="container">
            <?php if (empty($_SESSION['preloader'])) {
               // include_once $_SERVER['DOCUMENT_ROOT'] . SITE_TEMPLATE_PATH . '/include/modules/pre-loader.php';
            }
            if (($path[1]) && ($not404)) {
